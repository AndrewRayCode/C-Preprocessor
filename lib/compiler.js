...
Processor.prototype.success = function() {
  ...
  else this.parent._success(this.result);
};
...
Processor.prototype.addDefines = Compiler.prototype.addDefines = function(
  line,
  withConst,
  withMacros
) {
...
// Create a constant
Processor.prototype.createConstant = Compiler.prototype.createConstant = function(
  name,
  value,
  addDefines
) {
...
Processor.prototype._compConst = Compiler.prototype._compConst = function(
  name,
  value
) {
...
Processor.prototype.addConstant = Compiler.prototype.addConstant = function(
  line,
  i,
  constant
) {
...
Processor.prototype.createMacro = Compiler.prototype.createMacro = function(
  name,
  text
) {
...
Processor.prototype.addMacro = Compiler.prototype.addMacro = function(
  line,
  i,
  macro
) {
